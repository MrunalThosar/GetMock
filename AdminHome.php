...
$result = mysqli_query($con,"SELECT * FROM test where created_by='$user'");

echo "<table border='1'><tr><th>test ID</th><th>Test name</th><th>questions</th><th>Result</th></tr>";
...
echo "<tr><td>$id</td><td>$name</td><td>$noq</td><td><a href='viewresult.php?key=$id'> View Result </a></td></tr>";
